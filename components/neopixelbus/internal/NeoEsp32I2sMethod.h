...
#ifndef NEOESP32I2SMETHIOD_H
#define NEOESP32I2SMETHIOD_H

extern "C"
{
//#include <Arduino.h>
#include "Esp32_i2s.h"
#include <stdint.h>	// added for idf-port ( uint16_t )
#include <stdlib.h>	// added for idf-port ( size_t )
#include <freertos/portmacro.h>	// added for idf-port ( vPortYield )
}
...
public:
    ...
    ~NeoEsp32I2sMethodBase()
    {
		...
		// deactivated for idf-port (really needed ?? just destructor)
		// pinMode(_pin, INPUT);
